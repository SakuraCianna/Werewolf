...
export const LiveSubtitles: React.FC<LiveSubtitlesProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-1 px-2 shrink-0">
      <div className="relative rounded-2xl bg-gradient-to-r from-slate-950 via-[#0d1322] to-slate-950 border border-amber-500/25 p-2.5 sm:p-3 shadow-lg backdrop-blur-md overflow-hidden">
        {/* 四角典雅金边装饰线 */}
        ...
        {/* 同传打字内容呈现区 */}
        <div className="min-h-[36px] sm:min-h-[42px] flex items-center">
          {transcript ? (
            <p className="text-xs sm:text-sm text-slate-100 leading-relaxed font-sans font-medium line-clamp-2">
